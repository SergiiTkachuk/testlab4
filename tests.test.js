...
describe('TaskManager', () => {
  ...
  describe('showExpiredTasks', () => {
    test('should display a list of expired tasks', () => {
      ...
      expect(console.log).toHaveBeenCalledWith(`  ID: ${taskManager[0].id}`);
      expect(console.log).toHaveBeenCalledWith('  Title: Task 1');
      ...
      expect(console.log).toHaveBeenCalledWith(`  ID: ${taskManager[1].id}`);
      expect(console.log).toHaveBeenCalledWith('  Title: Task 2');
